...
public class Constants
{
  ...
  public static String NEW_ACCOUNT_DETAILS = "New Account Details";
  public static String RETRIEVE_ACCOUNT_DETAILS = "Retrieve Account Details";
  public static String UPDATE_ACCOUNT_DETAILS = "Update Account Details";
